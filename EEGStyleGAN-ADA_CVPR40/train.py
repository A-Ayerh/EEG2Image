...
from single_npy_dataset import SingleNpyFileDataset
...
def setup_training_loop_kwargs(
    ...
    args.training_set_kwargs = dnnlib.EasyDict(class_name='training.dataset.EEG2ImageDataset', path=data, use_labels=True, max_size=None, xflip=False)
    ...
    cfg_specs = {
        ...
        'cifar':     dict(ref_gpus=2,  kimg=80, mb=64, mbstd=32, fmaps=1,   lrate=0.0025, gamma=0.01, ema=500, ramp=0.05, map=2),
    }
