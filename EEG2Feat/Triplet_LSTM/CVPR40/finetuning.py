...
if __name__ == '__main__':
    ...
    validation_path = config.test_path
    ...
    train_dataloader = DataLoader(train_data, batch_size=batch_size, shuffle=True, pin_memory=False, drop_last=False)
    ...
    ckpt_path = 'EXPERIMENT_{}/bestckpt/eegfeat_all_0.9665178571428571.pth'.format(experiment_num)
