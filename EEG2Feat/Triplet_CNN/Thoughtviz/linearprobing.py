...
if __name__ == '__main__':
    ...
    for i in tqdm(natsorted(os.listdir(base_path + train_path))):
        ...
        x_train_subject.append(loaded_array[4])
    ...
    for i in tqdm(natsorted(os.listdir(base_path + test_path))):
        ...
        x_test_subject.append(loaded_array[4])
    ...
    ckpt_lst = natsorted(glob('EXPERIMENT_{}/bestckpt/eegfeat_all_0.9720982142857143.pth'.format(experiment_num)))
