...
if __name__ == '__main__':
    ...
    for i in tqdm(natsorted(os.listdir(base_path + test_path))):
        ...
        x_test_eeg.append(np.expand_dims(loaded_array[0].reshape(124, 32).T, axis=0))
        ...
        label_test.append(loaded_array[1][0]-1)
    ...
    ckpt_lst = natsorted(glob('EXPERIMENT_{}/bestckpt/eegfeat_all_0.3669921875.pth'.format(experiment_num)))
