...
class Umap:
    ...
    def plot(self, text_embed, labels, score, exp_type, experiment_num, epoch, proj_type):
        ...
        ax.legend(loc='center left', fancybox=True, shadow=True, ncol=1, bbox_to_anchor=(1, 0.5))
        plt.tight_layout()
...
class TsnePlot:
    ...
    def plot3d(self, embedding, labels, score, exp_type, experiment_num, epoch, proj_type):
        ...
        ax.set_xlim3d(0.35, 0.5)
        ax.set_zlim3d(0.3, 0.5)
        ax.set_ylim3d(0.35, 0.5)
        ...
        plt.tight_layout()
        plt.savefig('EXPERIMENT_{}/{}/tsne/{}_{}_eeg_tsne3d_plot_kmean_{}.pdf'.format(experiment_num, exp_type, epoch, proj_type, score))
        plt.close()
        return reduced_embedding
