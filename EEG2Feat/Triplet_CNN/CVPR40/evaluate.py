...
if __name__ == '__main__':
    ...
    test_subjects  = torch.from_numpy(test_subjects).long().to(device)

    test_data       = EEGDataset(x_test_eeg, x_test_image, test_labels, test_subjects)
    ...
    ckpt_path = 'EXPERIMENT_{}/bestckpt/eegfeat_all_0.9720982142857143.pth'.format(experiment_num)
